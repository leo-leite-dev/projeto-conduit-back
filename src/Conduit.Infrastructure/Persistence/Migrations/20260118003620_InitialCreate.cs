    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_article_favorites", x => new { x.ArticleId, x.ProfileId });
                    table.ForeignKey(
                        name: "FK_article_favorites_articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_article_favorites_profiles_ProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_article_favorites_ProfileId",
